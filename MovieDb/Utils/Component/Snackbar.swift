...
@objc public enum SnackbarDuration: Int {
    case short = 1
    case middle = 3
    case long = 5
...
@objc public enum SnackbarAnimationType: Int {
    case fadeInFadeOut
...
open class Snackbar: UIView {
    ...
    fileprivate static let snackbarDefaultFrame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 60)
    ...
    public typealias ActionBlock = (_ snackbar:Snackbar) -> Void
    
    /// Dismiss callback closure definition.
    public typealias DismissBlock = (_ snackbar:Snackbar) -> Void
    
    /// Swipe gesture callback closure
    public typealias SwipeBlock = (_ snackbar: Snackbar, _ direction: UISwipeGestureRecognizer.Direction) -> Void
    
    // MARK: - Public property.
    
    /// Tap callback
    @objc open dynamic var onTapBlock: ActionBlock?
    
    /// Swipe callback
    @objc open dynamic var onSwipeBlock: SwipeBlock?
    ...
    /// Action callback.
    @objc open dynamic var actionBlock: ActionBlock? = nil
    
    /// Second action block
    @objc open dynamic var secondActionBlock: ActionBlock? = nil
    
    /// Dismiss callback.
    @objc open dynamic var dismissBlock: DismissBlock? = nil
    
    /// Snackbar display duration. Default is Short - 1 second.
    @objc open dynamic var duration: SnackbarDuration = SnackbarDuration.short
    
    /// Snackbar animation type. Default is SlideFromBottomBackToBottom.
    @objc open dynamic var animationType: SnackbarAnimationType = SnackbarAnimationType.slideFromBottomBackToBottom
    ...
    @objc open dynamic var actionTextColor: UIColor = AppColor.textGray.color {
        didSet {
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    @objc public init(message: String, duration: SnackbarDuration) {
        super.init(frame: Snackbar.snackbarDefaultFrame)
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    public init(customContentView: UIView, duration: SnackbarDuration) {
        super.init(frame: Snackbar.snackbarDefaultFrame)
        self.duration = duration
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    public init(message: String, duration: SnackbarDuration, actionText: String, actionBlock: @escaping ActionBlock) {
        super.init(frame: Snackbar.snackbarDefaultFrame)
        self.duration = duration
        self.message = message
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    public init(message: String, duration: SnackbarDuration, actionText: String, messageFont: UIFont, actionTextFont: UIFont, actionBlock: @escaping ActionBlock) {
        super.init(frame: Snackbar.snackbarDefaultFrame)
        self.duration = duration
        self.message = message
        self.actionText = actionText
...
public extension Snackbar {
    ...
    @objc public func show() {
        ...
        iconImageViewWidthConstraint?.constant = iconImageView.isHidden ? 0 : Snackbar.snackbarIconImageViewWidth
        actionButtonMaxWidthConstraint?.constant = actionButton.isHidden ? 0 : actionMaxWidth
        secondActionButtonMaxWidthConstraint?.constant = secondActionButton.isHidden ? 0 : actionMaxWidth
        ...
        if let superView = containerView ?? UIApplication.shared.delegate?.window ?? UIApplication.shared.keyWindow {
            ...
            let minHeightConstraint = NSLayoutConstraint.init(
                ...
                toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: Snackbar.snackbarMinHeight)
    ...
    fileprivate func showWithAnimation() {
        ...
        let snackbarHeight = systemLayoutSizeFitting(.init(width: superViewWidth - leftMargin - rightMargin, height: Snackbar.snackbarMinHeight)).height
